...
def main():
    ...
    Rules:
        ...
        Cards 2 through 10 are worth thirt face value.
...
def getBet(maxBet):
    """Ask the plaeyr how much they want tot bet for this round."""
    while True:
